...
export const rooms: Room[] = [
  ...
  },
  {
    ...
    name: "Shahram-Hammad-Usama Room",
    floor: "top",
    capacity: 3,
    privacy_level: "shared",
  },
...
export const users: HouseUser[] = [
  ...
  },
  {
    ...
    room_name: "Shahram-Hammad-Usama Room",
...
export const areas: Area[] = [
  ...
  },
  {
    ...
    floor: "top",
    description: "Shared bathroom used by everyone except Sheraz.",
    everyone_uses: false,
    excluded_members: ["Sheraz"],
  },
  {
    id: "area-2-person-bedroom",
    name: "Uzair-Sheraz Room",
    floor: "top",
    description: "Private room responsibility for Uzair and Sheraz.",
    everyone_uses: false,
    excluded_members: ["Shahram", "Hammad", "Usama", "Ali"],
  },
  {
    id: "area-3-person-bedroom",
    name: "Shahram-Hammad-Usama Room",
    floor: "top",
    description: "Private room responsibility for Shahram, Hammad, and Usama.",
    everyone_uses: false,
    excluded_members: ["Uzair", "Sheraz", "Ali"],
  },
  {
    id: "area-single-bedroom",
    name: "Ali Room",
    floor: "top",
    description: "Private room responsibility for Ali.",
    everyone_uses: false,
    excluded_members: ["Uzair", "Sheraz", "Shahram", "Hammad", "Usama"],
  },
];
...
export const defaultTasks: Task[] = [
  ...
  },
  {
    ...
    description: "Toilet, shower, sink, mirror, floor, and towel area. Sheraz is excluded.",
    ...
    preferred_window:
      (userIndex + dayIndex) % 3 === 0
        ...
        : (userIndex + dayIndex) % 3 === 1
          ? "Afternoon"
          : "Morning",
    unavailable: day === 5 && user.name === "Sheraz",
    notes: null,
  })),
);
...
export const aiRecommendations: AIRecommendation[] = [
  {
    ...
    summary:
      "Avoid Uzair for top floor bathroom this week because he completed it last week.",
    recommendation: {
...
export const taskSwaps: TaskSwap[] = [
  {
    ...
    accepted_by: null,
    status: "requested",
    reason: "Hammad is unavailable Thursday evening and needs a fair swap.",
    created_at: iso(subDays(today, 1)),
