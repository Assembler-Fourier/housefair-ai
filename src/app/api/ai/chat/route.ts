...
export async function POST(request: Request) {
  ...
  if (includesAny(message, ["weekly plan", "generate plan", "plan week"])) {
    answer =
      "Here is a draft weekly plan for review. It respects Blair being excluded from the top floor bathroom and considers points, heavy-task history, issues, availability, and guests.";
    responsePlan = plan;
    ...
    answer = bathroomPick
      ...
      : "I recommend assigning bathrooms to the eligible person with the lightest recent heavy-task load. Blair must not be assigned the top floor bathroom.";
