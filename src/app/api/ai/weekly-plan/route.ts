      ...
      input: [
        {
          role: "system",
          content:
            "You are HouseFair AI Manager. Produce fair roommate cleaning plans. Never make permanent assignments. Respect configured area eligibility and excluded-members rules. Return compact JSON only.",
        },
        {
          role: "user",
